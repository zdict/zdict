...
class Color(metaclass=ColorConst):
    ...
    @classmethod
    def format_highlight(self, s='', grp_regex=r'.*', color_bg='org',
                         color_h='org', indent=0):
        '''
        :type s: str
        :param s: message
        :param: grp_regex: replacement-regex with group 1
            being the text to be retained and highlighted
